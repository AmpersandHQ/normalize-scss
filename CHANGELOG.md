...
- Remove opinionated properties on fieldset element. [`9e5bee4`](https://github.com/AmpersandHQ/normalize-scss/commit/9e5bee421e47747ebaf568d7a41560afba1961d2)
...
- Update `Browser support` section from `README.md` [`#507`](https://github.com/AmpersandHQ/normalize-scss/pull/507)
...
- Don't output vertical rhythm on h1 by default. #88 [`a3e5051`](https://github.com/AmpersandHQ/normalize-scss/commit/a3e5051290ddc889f1dfcd30e35730b017a506ca)
...
- Add comments about !default usage in default fork. #72 [`17dbd30`](https://github.com/AmpersandHQ/normalize-scss/commit/17dbd30f6bbd67d0af5dfc0ec6f0e2459a0aea6b)
...
#### [5.0.1](https://github.com/AmpersandHQ/normalize-scss/compare/5.0.0...5.0.1)
...
- Update travis test system list. [`5981153`](https://github.com/AmpersandHQ/normalize-scss/commit/5981153954e950ffd3eba3d0cafc14ff2b739e5a)
...
- Tag 4.0.1. [`0f0d3e3`](https://github.com/AmpersandHQ/normalize-scss/commit/0f0d3e313400fd36439d910372868a5e7d61b445)
...
- Add tests for Compass fork version. [`5758744`](https://github.com/AmpersandHQ/normalize-scss/commit/5758744b4e5ac6d8a971ce4f0cb383ac3c637dd2)
...
- Add eyeglass support. [`299d01c`](https://github.com/AmpersandHQ/normalize-scss/commit/299d01c2c84522a5b009140c5b51d4627af9a822)
...
- Update markdown in README. [`bcfa1da`](https://github.com/AmpersandHQ/normalize-scss/commit/bcfa1dae67519fe8345473f5ccff9f3138a6d475)
...
#### [3.0.1+normalize.3.0.1](https://github.com/AmpersandHQ/normalize-scss/compare/3.0.0+normalize.3.0.1...3.0.1+normalize.3.0.1)
...
#### [3.0.0-alpha.2+normalize.3.0.0](https://github.com/AmpersandHQ/normalize-scss/compare/3.0.0-alpha.1+normalize.2.1.3...3.0.0-alpha.2+normalize.3.0.0)
...
- Revert `textarea` alignment modification [`20e5822`](https://github.com/AmpersandHQ/normalize-scss/commit/20e58223c9f07607289063c649a7e0e569ec7f97)
...
#### [2.2.0+normalize.2.1.3](https://github.com/AmpersandHQ/normalize-scss/compare/2.1.3...2.2.0+normalize.2.1.3)
...
#### [2.1.3](https://github.com/AmpersandHQ/normalize-scss/compare/2.1.2...2.1.3)
...
- Skip adjust-font-size-to() usage when $strict-normalize is true. Issue #13 [`1654f62`](https://github.com/AmpersandHQ/normalize-scss/commit/1654f62ac8cec9e4619ea76a420fda3ee625995d)
...
- Fix typo in CONTRIBUTING.md [`7749af6`](https://github.com/AmpersandHQ/normalize-scss/commit/7749af6f3dd07459ce4ad5798052e81024d45f68)
...
- Update CHANGELOG [`6729f5e`](https://github.com/AmpersandHQ/normalize-scss/commit/6729f5e8f5973c3b31a7a7baab5fdb7860aa623d)
...
- Remove &lt;audio&gt;, &lt;video&gt;, &lt;canvas&gt; display set to inline-block. Default display is inline. Fix #10 [`#10`](https://github.com/AmpersandHQ/normalize-scss/issues/10)
- Move font-size:100% into html ruleset, fix #5. Remove placeholder body line-height. [`#5`](https://github.com/AmpersandHQ/normalize-scss/issues/5)
- Remove input[type="search"] WebKit decoration from Safari and Chrome in OSX, corrects excess inner padding. Fix #3 [`#3`](https://github.com/AmpersandHQ/normalize-scss/issues/3)
- Make tap-highlight-color fix work for Android devices. Fix #2 [`#2`](https://github.com/AmpersandHQ/normalize-scss/issues/2)
- Edit demo file; addition of &lt;form&gt; elements, &lt;mark&gt;, &lt;blockquote&gt;, and clearer inline element tests. [`25d2e3e`](https://github.com/AmpersandHQ/normalize-scss/commit/25d2e3e421f013ddca0f1a2002c2cd4c8a05df79)
- Convert CSS comments to Sass comments. [`78717dd`](https://github.com/AmpersandHQ/normalize-scss/commit/78717dde1e858af9791820ba4f86994e4831fe37)
- Convert CSS comments to Sass comments. [`83a2050`](https://github.com/AmpersandHQ/normalize-scss/commit/83a205074c33538c85c2560382170505fc81b989)
- Convert CSS comments to Sass comments. [`1238e94`](https://github.com/AmpersandHQ/normalize-scss/commit/1238e94f64f84cc190bc315eb4286e8e1d95d426)
- Updated demo.html [`2c8c7aa`](https://github.com/AmpersandHQ/normalize-scss/commit/2c8c7aaba80429d8b251ed0983cb306dd4e792a1)
- Demo: Add box-sizing tests; add more HTML5 &lt;input&gt; type examples; add &lt;figure&gt; example; reorganise elements [`696c274`](https://github.com/AmpersandHQ/normalize-scss/commit/696c274bcd56c930db114054643cf570b4bfec57)
- Initial [`d8335d3`](https://github.com/AmpersandHQ/normalize-scss/commit/d8335d302adef6fe2632925167c358ef1c7c6145)
- Drop legacy browser support [`7e01498`](https://github.com/AmpersandHQ/normalize-scss/commit/7e014980b9155c8ef77b6d08c2ac352382a095b5)
- Add bold font-weight to &lt;b&gt; and &lt;strong&gt;. Add font-size to &lt;pre&gt; &lt;code&gt; &lt;kbd&gt; &lt;samp&gt; (was missing). Introduce more links to further reading. [`f28538a`](https://github.com/AmpersandHQ/normalize-scss/commit/f28538a363d3f9052dc54a3bce1fba81ece4afa4)
- Normalize and personalized sizing and spacing [`57fd887`](https://github.com/AmpersandHQ/normalize-scss/commit/57fd8879f5cfe32ade0235b50ad451fe8c0dcbf1)
- Minor changes to properties and values that could be shortened. Improve comment language and change section-comment format (via Jonathan Neal). [`ce0c346`](https://github.com/AmpersandHQ/normalize-scss/commit/ce0c3469e040b4d88663b03d1325cc274e35d4c9)
- Update README; remove normalize.metrics.css [`fba85c2`](https://github.com/AmpersandHQ/normalize-scss/commit/fba85c2781a2a2763c3382990ff9655a684b2e24)
- Minor consistency adjustments [`93beaa2`](https://github.com/AmpersandHQ/normalize-scss/commit/93beaa2e949ccdacf6ff00aaceca541b815e1f14)
- Make comments less verbose [`e6afa1f`](https://github.com/AmpersandHQ/normalize-scss/commit/e6afa1ffbcdabd90f9108b20d30919769e015a24)
- Update CSS comment wording [`f52da74`](https://github.com/AmpersandHQ/normalize-scss/commit/f52da7461fc69c97f2417239bc6c8fdef58090e4)
- Update headings [`10009af`](https://github.com/AmpersandHQ/normalize-scss/commit/10009af09e8c51c67438f5169ee803c3185ad00b)
- Demo: modify form element tests to include both input-inside-label and input-outisde-label markup options. Include examples of form parts wrapped in &lt;p&gt; alongside examples wrapped in &lt;div&gt;. Add tel and file &lt;input&gt; types. [`a5a0686`](https://github.com/AmpersandHQ/normalize-scss/commit/a5a0686ed9e001acca2cc8cb3f3f127db59e917c)
- Style HTML5 embedded elements. Remove default cursor from &lt;html&gt;. Reformat comments [`9652da9`](https://github.com/AmpersandHQ/normalize-scss/commit/9652da94c771d6c3cb7571897221f85d8e2ca92d)
- Normalize &lt;a&gt; colors. Remove &lt;small&gt; line-height (no effect when not block-level). Reorganise file and edit comments. [`56d63df`](https://github.com/AmpersandHQ/normalize-scss/commit/56d63dfe7a1bdcbb4992fbf66a1ab74f89b44936)
- Add table element normalization. Add default font-size and line-height to &lt;body&gt;. Set font-family on &lt;body&gt; and form elements to improve consistency. Set font-size:100% on form elements so they inherit body's font-size. [`a27246f`](https://github.com/AmpersandHQ/normalize-scss/commit/a27246fcabe7a5b57e08341aac36b81c287cac71)
- Language update [`3ce871a`](https://github.com/AmpersandHQ/normalize-scss/commit/3ce871adc20623e1849a419e8981b4a4da23316d)
- Add {vertical-align:middle} to form elements in IE6/7 - fixes their incorrect label-input alignment when using baseline. Reorder the form element rulesets [`c8aafe3`](https://github.com/AmpersandHQ/normalize-scss/commit/c8aafe34e697807fcf30b12b35f6de2144ca07dc)
- Improved display inline block [`4f1ba27`](https://github.com/AmpersandHQ/normalize-scss/commit/4f1ba2796321bbb8ed38aa80ad5cfc6c613d4178)
- Minor copy and comment adjustments [`b757970`](https://github.com/AmpersandHQ/normalize-scss/commit/b7579700ead7f94ddb07687e0ec8fbf8efc4ad93)
- Clearing heading tests added to the demo [`4288d2b`](https://github.com/AmpersandHQ/normalize-scss/commit/4288d2b7cf49f826e5662cbcc02edbea51621875)
- Add MIT License [`31f72b5`](https://github.com/AmpersandHQ/normalize-scss/commit/31f72b55beef89e08c27521211bcac2724c56237)
- Remove `hr` and separate some margin normalizations [`cb17683`](https://github.com/AmpersandHQ/normalize-scss/commit/cb176831b9adb32036e83087f286c0ae6c0eae74)
- Add compass/support variables for legacy IE handling. [`0a18772`](https://github.com/AmpersandHQ/normalize-scss/commit/0a1877270ad98674fa7f907499b13e5812409e65)
- Apply vertical rhythm mixins to elements that have font-size. [`31a0989`](https://github.com/AmpersandHQ/normalize-scss/commit/31a09896a1fc12c331ed2f8feacd3d0279221096)
- Add blockquote and list normalization (previously in normalize.metrics.css) [`4cf8cf3`](https://github.com/AmpersandHQ/normalize-scss/commit/4cf8cf3e6e40a738e23161d08bfcac70b00ba555)
- Fix indentation and update timestamp [`567af2e`](https://github.com/AmpersandHQ/normalize-scss/commit/567af2e7d68d2bebb6428748190fd7dc5e6a4e51)
- Add normalization of &lt;form&gt; and &lt;fieldset&gt; elements. Add input[type='reset'] to box sizing normalization. Add cursor:pointer for clickable inputs/buttons. [`11d60fe`](https://github.com/AmpersandHQ/normalize-scss/commit/11d60fe7ba81ebb83367077adfa01ebec9dc85b8)
- Correct the box sizing declarations required to improve cross-browser consistency of specific input types [`8061c67`](https://github.com/AmpersandHQ/normalize-scss/commit/8061c67cf7f9b4b68c182dc6a4dce28393df5f40)
- Update README.md for compass port. [`10e86c3`](https://github.com/AmpersandHQ/normalize-scss/commit/10e86c34ed75921bb1c3365f2edfa2066674be9d)
- Move block styling rules before inline styling rules. [`270ccbf`](https://github.com/AmpersandHQ/normalize-scss/commit/270ccbf4f6f79ba8688afb20e8f4ad59553bc8aa)
- Notes [`b9ad7ae`](https://github.com/AmpersandHQ/normalize-scss/commit/b9ad7aea10819c766aec31268db7eea9ad7487c5)
- Update [`ef12292`](https://github.com/AmpersandHQ/normalize-scss/commit/ef12292cc21dbd720b711ccf55a594d9dcb0fc18)
- Update [`15f071e`](https://github.com/AmpersandHQ/normalize-scss/commit/15f071eb438174857b449739b13587aaee365362)
- Include http: in path to HTML5 Shim. Remove inputs with 'required' and 'pattern' attributes: not relevant to this demo. [`ab0304e`](https://github.com/AmpersandHQ/normalize-scss/commit/ab0304e248d85915ad76d0270d95e813ee153ac4)
- Update README with more details and link to demo [`9e9faec`](https://github.com/AmpersandHQ/normalize-scss/commit/9e9faec50767f2066e5e1d56995896cfb691d7d9)
- Normalize typography [`f1a096a`](https://github.com/AmpersandHQ/normalize-scss/commit/f1a096a4986c2ab74b4a8352697a099551866b08)
- Combine leader and trailer margins on headings into a single rule. [`9e786bb`](https://github.com/AmpersandHQ/normalize-scss/commit/9e786bb5c43cd8a66d0158e3f87ac3825fcc6743)
- Update CSS comments [`e469f75`](https://github.com/AmpersandHQ/normalize-scss/commit/e469f757fd9ce9b9970e65bab66d941f64e32939)
- Revert addition of input placeholder rules [`99b187d`](https://github.com/AmpersandHQ/normalize-scss/commit/99b187d1a20c8548e6a6e876f75a28c6e24bff2d)
- Add line-height:normal to &lt;input&gt; and &lt;button&gt; elements to match Firefox 3/4 value (set with !important in the UA stylesheet) [`4fdeb70`](https://github.com/AmpersandHQ/normalize-scss/commit/4fdeb702f19aef7b6891106285ba8ff9fddc801a)
- Minor tidy up of &lt;pre&gt;&lt;code&gt; HTML example [`a974ee7`](https://github.com/AmpersandHQ/normalize-scss/commit/a974ee71f94d8bdce8cc2d982bad152d3bf38bfd)
- Minor change to test file [`138536c`](https://github.com/AmpersandHQ/normalize-scss/commit/138536c843c1cee9f8dc1f80cc985c21acd0b24d)
- Normalize lists [`450aa56`](https://github.com/AmpersandHQ/normalize-scss/commit/450aa56a20ea3be33a1960311df1fbf85e33fd6f)
- First README.md [`a9aa6b7`](https://github.com/AmpersandHQ/normalize-scss/commit/a9aa6b7a05c973acb377bde462235f2d081f8ce0)
- Reintroduce fix for WebKit audio/video control bug [`79b3d21`](https://github.com/AmpersandHQ/normalize-scss/commit/79b3d21b697e94675d748cd9d42409b83318d2b5)
- Change vertical-align for inline-block elements to baseline. Set textarea vertical-align to top. [`08fc3b3`](https://github.com/AmpersandHQ/normalize-scss/commit/08fc3b3d9cb850155c401ae74797f2739ce869ce)
- Add [hidden] attribute normalization [`b3796b4`](https://github.com/AmpersandHQ/normalize-scss/commit/b3796b42b5c8dedce2e35b4b769fe1e3b8c72f3d)
- Add -webkit-appearance:button to clickable input types, fixes inability to style them in iOS. Remove input[type=image] as it already receives a pointer cursor and should not receive button appearance [`1be44f3`](https://github.com/AmpersandHQ/normalize-scss/commit/1be44f3b2a79af5d463c7ea0264fee0e6fa464ca)
- Add placeholder color normalization [`49392e9`](https://github.com/AmpersandHQ/normalize-scss/commit/49392e9df27b7036609f56861679e8cf9c0ea264)
- Add component.json [`701c73b`](https://github.com/AmpersandHQ/normalize-scss/commit/701c73be55386643423af180ad88acea1a9e7fac)
- Language [`354859e`](https://github.com/AmpersandHQ/normalize-scss/commit/354859e740250a009152d2977202ef2119778044)
- Combine the two WebKit search input pseudo-element rules [`f913304`](https://github.com/AmpersandHQ/normalize-scss/commit/f9133044985e7672b789784ed2d372cb1f6972c5)
- Establish a base vertical rhythm with with the vertical_rhythm partial. [`eb0f8ad`](https://github.com/AmpersandHQ/normalize-scss/commit/eb0f8ad55f2677e901621942140ab018b9b72e19)
- Reintroduce &lt;audio&gt;, &lt;canvas&gt;, &lt;video&gt; display setting [`82e1797`](https://github.com/AmpersandHQ/normalize-scss/commit/82e1797ed2867cd3fc9bb1e9d78013de8600a206)
- Manual merge with GitHub master branch [`e65602a`](https://github.com/AmpersandHQ/normalize-scss/commit/e65602a3b977fc4de8fbd5a9010b09023a09ef30)
- Add CHANGELOG [`9f5837a`](https://github.com/AmpersandHQ/normalize-scss/commit/9f5837a95a33ab7e3b34b7ebc91a7d20623ae9cc)
- Add interactive content tests to demo.html [`1840623`](https://github.com/AmpersandHQ/normalize-scss/commit/18406231ccc915d26dd0707a754b9e6cde5abe5a)
- Update text in README. [`dfa5d34`](https://github.com/AmpersandHQ/normalize-scss/commit/dfa5d34f65b54d7bb6ee0e20fe05a15223bd64b0)
- Fix text-size-adjust so it doesn't prevent manual zooming in WebKit or iOS [`be21f76`](https://github.com/AmpersandHQ/normalize-scss/commit/be21f763ee86c7041f35e3beba8567573fdee9fd)
- Merge brnach 'normalize-with-sass' into normalize-with-compass [`98d3eab`](https://github.com/AmpersandHQ/normalize-scss/commit/98d3eab5396616db276eca426e2e28e885e9298e)
- Improve inline documentation comments [`e686b29`](https://github.com/AmpersandHQ/normalize-scss/commit/e686b29b8152d98668cb4a42b8492799eda4263b)
- Separate [hidden] and audio:not([controls]) to prevent entire rule being dropped in IE8 [`775989f`](https://github.com/AmpersandHQ/normalize-scss/commit/775989f4c700ee9ddae77e644b71f92aa81c1b55)
- Remove remnants of IE &lt;audio&gt; hack [`7855316`](https://github.com/AmpersandHQ/normalize-scss/commit/78553162350a41d56b4c3ff1fd7a4222e2d531c7)
- Add small improvements to `legend` normalization. [`23c6fe1`](https://github.com/AmpersandHQ/normalize-scss/commit/23c6fe17d21c32899d60dd159b86611662dec7db)
- Normalize &lt;figure&gt; margins [`df279d8`](https://github.com/AmpersandHQ/normalize-scss/commit/df279d89b45399d942c3b35ab119fe579ae06520)
- Re-set cursor to default for disabled `input` and `button`. [`fe15b8f`](https://github.com/AmpersandHQ/normalize-scss/commit/fe15b8f862d7477b37298aab88c1fc61c4d38808)
- Simplify list styling [`8bc3db0`](https://github.com/AmpersandHQ/normalize-scss/commit/8bc3db07cecfaf87828d16f409ad22366ebb170b)
- Remove search cancel button from search inputs on Mac OS X. [`efd8220`](https://github.com/AmpersandHQ/normalize-scss/commit/efd8220019a5cb25b94a959a7faf9c08bafeb827)
- Set text-size-adjust to 100% [`0af8488`](https://github.com/AmpersandHQ/normalize-scss/commit/0af84884f524c0df8cdd867523052ead9d653231)
- Update: &lt;body&gt; [`6671403`](https://github.com/AmpersandHQ/normalize-scss/commit/6671403e3ba83cf721795cdc888b7bcda85e374b)
- Remove default `a` and `a:visited` color normalizations. [`26f9a3f`](https://github.com/AmpersandHQ/normalize-scss/commit/26f9a3f065e312727f272417b2be258a69ca3914)
- Add vertical-align:baseline to form elements [`9f821f0`](https://github.com/AmpersandHQ/normalize-scss/commit/9f821f06e3dc8b6c42141f6026759a1a749c55ae)
- Adjust `small` font size normalization [`0cdbf7c`](https://github.com/AmpersandHQ/normalize-scss/commit/0cdbf7c713b2a51db9510d412750db04d9a7fa1b)
- Align textarea with text-top. Improves readability and fixes FF3/4 odd 'baseline' alignment [`e58552d`](https://github.com/AmpersandHQ/normalize-scss/commit/e58552dbc097384e0f5e88813892fb424492425a)
- Minor format change to README [`953a5f5`](https://github.com/AmpersandHQ/normalize-scss/commit/953a5f522e11bda9a510a7d701c2cda97d4fad0c)
- Add placeholder color normalization [`f9572a4`](https://github.com/AmpersandHQ/normalize-scss/commit/f9572a461a6a3baf7f151c095ab23babc4937a39)
- Demo: add disabled input test and other minor updates. [`2326dcb`](https://github.com/AmpersandHQ/normalize-scss/commit/2326dcb082f9bf615ecdb6f1e0f8101a0a070cf5)
- Apply rhythm() function to elements with top and bottom margin. [`509d91b`](https://github.com/AmpersandHQ/normalize-scss/commit/509d91bca2721b203403415b1c3cec6e8381b217)
- Remove CSS expressions targeting IE6. Performance issue. [`d23156d`](https://github.com/AmpersandHQ/normalize-scss/commit/d23156d4e43ab0e4f69f53dd9b673e329a410be2)
- Add fix for legend not inheriting color in IE6/7/8/9 [`bac7c31`](https://github.com/AmpersandHQ/normalize-scss/commit/bac7c314a806bd5cef50333f61f0b064356a080f)
- Update [`efe4044`](https://github.com/AmpersandHQ/normalize-scss/commit/efe40441aae8529aa9411fa62c00b07ee0418576)
- Addresses placeholder text remaining visible on focus in Chrome [`2691e7a`](https://github.com/AmpersandHQ/normalize-scss/commit/2691e7ab14682dc8f9e942456887df0e35804087)
- Removed &lt;tags&gt; so they wouldn't conflict with procssor.com You can see the exact issue here http://img832.imageshack.us/img832/7329/tagnormalissues.png  [`db6ee26`](https://github.com/AmpersandHQ/normalize-scss/commit/db6ee260e335e1923efd6acfcedad42629402cdf)
- Update README with link to demo and license info [`b7216e5`](https://github.com/AmpersandHQ/normalize-scss/commit/b7216e5daa8ab86ffdc148c5ce5c3d8e00a853cf)
- Apply rhythm border mixins to elements with borders. [`3302855`](https://github.com/AmpersandHQ/normalize-scss/commit/33028551ab95011ae7bdfdd595b57b09d2908d10)
- Correct code format and update timestamp [`79e2c16`](https://github.com/AmpersandHQ/normalize-scss/commit/79e2c16ba5157c46ea4a129dd99420ac2f85f3f0)
- Update Compass support info in README. [`55c21ff`](https://github.com/AmpersandHQ/normalize-scss/commit/55c21ff268c4fe18a4ab51c796bfab6244c80b79)
- Remove unnecessary styles for &lt;td&gt; and &lt;th&gt;. All browsers apply same default styles. [`79c278f`](https://github.com/AmpersandHQ/normalize-scss/commit/79c278fa9658f95540b2dd795ddf4cfc62201c36)
- iOS text resizing [`86fc462`](https://github.com/AmpersandHQ/normalize-scss/commit/86fc462da1f21c9cc02c615741e377bffd4f9544)
- Minor change to &lt;pre&gt; etc font-family. Set {display:inline-block} only for audio[controls]. [`4bf81bb`](https://github.com/AmpersandHQ/normalize-scss/commit/4bf81bb8246c3c63b8397ce980262fca5e2ff503)
- Improved &lt;sup&gt; &lt;sub&gt; alignment [`341f0af`](https://github.com/AmpersandHQ/normalize-scss/commit/341f0af212f4ba4592ea3d2699719b9a688c0fd2)
- Use box-sizing mixin in place of box-sizing property. [`7e08d8d`](https://github.com/AmpersandHQ/normalize-scss/commit/7e08d8dcf90966efa6644350c4262c54c9a8a123)
- Remove stray IE 6/7 hack [`dcc17fd`](https://github.com/AmpersandHQ/normalize-scss/commit/dcc17fd21ab53f5e268ec1fda1037fab6bc61886)
- Minor copy changes to CSS comments [`7b3b5e4`](https://github.com/AmpersandHQ/normalize-scss/commit/7b3b5e48be2ed75f9c42177587ef6e11a63e209a)
- Add vertical-align:baseline to form elements [`b8f2b7b`](https://github.com/AmpersandHQ/normalize-scss/commit/b8f2b7b34e9f160bfc49720f5ea5da1cd7bf8ef0)
- Very minor copy typo fix and `zoom` property change. [`7372f50`](https://github.com/AmpersandHQ/normalize-scss/commit/7372f5025064ec2617a04daea16393da30d359bd)
- Update monospace font stack fix to work in Safari 4 [`013d724`](https://github.com/AmpersandHQ/normalize-scss/commit/013d72407e47978fe6ddad7a77a24b3935fb0ade)
- Add `summary` to the block-level display rule for HTML5 elements [`5e5496c`](https://github.com/AmpersandHQ/normalize-scss/commit/5e5496c026a0211ac2fdfd62cb59e25455dced55)
- Correct inaccurate description of [hidden] rule [`743ee8b`](https://github.com/AmpersandHQ/normalize-scss/commit/743ee8bc7b4c981c852cb1e4e8bd9658b8d801ce)
- Update README with link to 'contribute' wiki [`0357529`](https://github.com/AmpersandHQ/normalize-scss/commit/03575299fc8cba752a51fece7c35343085d6ed09)
- Add $base-font-family variable. [`c5d7db6`](https://github.com/AmpersandHQ/normalize-scss/commit/c5d7db6c43a82dceadafbd272fa8f683df28c085)
- Switch a:active and a:hover order [`91d958c`](https://github.com/AmpersandHQ/normalize-scss/commit/91d958cef94da074bcec105713c7b2b3518ea9f3)
- Set vertical-align:baseline for sub and sup [`cce41fe`](https://github.com/AmpersandHQ/normalize-scss/commit/cce41fedd32017576d42c90da771a46c797332bc)
- Minor edit to monospace font fix [`28f8e9b`](https://github.com/AmpersandHQ/normalize-scss/commit/28f8e9b4d315691cba752ce77e1c329a2a5161a3)
- Add additional abbr and dfn tests to the demo [`aec1395`](https://github.com/AmpersandHQ/normalize-scss/commit/aec13957659fae98f3de509a07408a98e930960a)
- Add missing @import for box-sizing mixin. [`1c30608`](https://github.com/AmpersandHQ/normalize-scss/commit/1c30608e88d136ff840308b986fedcd7209ba713)
- Vendor-prefixed properties precede their standard counterparts [`7514427`](https://github.com/AmpersandHQ/normalize-scss/commit/7514427a0d41b7c7a073b37b3332adc48a9018a8)
- Remove temporary Chrome pre-13 fix for audio/video control styling bug. [`4d81be6`](https://github.com/AmpersandHQ/normalize-scss/commit/4d81be63832501608fe8ae27cfdefef3f67664de)
- Remove .gitignore [`6de1f05`](https://github.com/AmpersandHQ/normalize-scss/commit/6de1f055d654643dd074e3c166f7ec5089c7d2e6)
- Improve accuracy of &lt;img&gt; style comments [`f892df7`](https://github.com/AmpersandHQ/normalize-scss/commit/f892df74b12bc3480783ced73e589689f43e2230)
- Update comment for img border normalization to include reference to Firefox 3 [`f3de91a`](https://github.com/AmpersandHQ/normalize-scss/commit/f3de91ac5181db6711d33c0c737a4fbd223d822f)
- Formatting [`e3f2352`](https://github.com/AmpersandHQ/normalize-scss/commit/e3f2352235f31addd1f6f60c98832d903d9a299e)
- Remove `details` from the rule applying padding-left to lists. [`6fc4111`](https://github.com/AmpersandHQ/normalize-scss/commit/6fc41118f727ef8a047640faefce9f64e4dbe9e6)
- Update CSS comments [`0f1f244`](https://github.com/AmpersandHQ/normalize-scss/commit/0f1f244aecbc8549809fd64e2f99b3bae47e0efc)
- Minor formatting correction [`64ac7d0`](https://github.com/AmpersandHQ/normalize-scss/commit/64ac7d0c1d7febead0e0d5a4f1819024235d3be2)
- Remove link to normalize.metrics.css - move away from 'black boxing' the 'normalizing' styles. [`7c32ea1`](https://github.com/AmpersandHQ/normalize-scss/commit/7c32ea1bf295c82c7e86a7c61cc1d10b895447b5)
- Update .gitignore [`07eece8`](https://github.com/AmpersandHQ/normalize-scss/commit/07eece8e1d3a69b551c3467f0106b95ab0dbc6fa)
- Include link to Procssor for those who want a different CSS formatting style [`410b484`](https://github.com/AmpersandHQ/normalize-scss/commit/410b484a54d7341b302c258108188767c20825c7)
- Change dummy href value [`db6c8ec`](https://github.com/AmpersandHQ/normalize-scss/commit/db6c8ecd8bd85a0e6065433411c3006cea34506d)
- Remove [vertical-align:top] from [pre, code, kbd, samp]. Was meant to be for iOS but causes issues. [`6546f40`](https://github.com/AmpersandHQ/normalize-scss/commit/6546f401e4571a84fe5b49deb98c20ce79b643ca)
- Typo correction [`0c08646`](https://github.com/AmpersandHQ/normalize-scss/commit/0c08646b9d86dfe9737fb9c8be9236e2cb2cb02d)
- Minor change to outline value (none to 0) [`c71f67d`](https://github.com/AmpersandHQ/normalize-scss/commit/c71f67d42a57691483267db17743e751b65f8c84)
- Proper line-height assignment [`2fddc3c`](https://github.com/AmpersandHQ/normalize-scss/commit/2fddc3c5733b35461084ecda5a6a45efccbf65a7)
- Convert deprecated /*! */ comment style into /* */ comment. [`ab537ae`](https://github.com/AmpersandHQ/normalize-scss/commit/ab537aec0977fa813e1bbb77db0172b2678f318a)
- Convert deprecated /*! */ comment style into /* */ comment. [`74c58c4`](https://github.com/AmpersandHQ/normalize-scss/commit/74c58c4c5adbff0a0bf79a871499bd5617ab5f3b)
- Remove overflow:hidden from body, cuts off content of fixed-width elements [`6ed1d6f`](https://github.com/AmpersandHQ/normalize-scss/commit/6ed1d6f7e53bc294383b6aecd90bb4c6f3710c98)
- Correct meta viewport to use initial-scale [`0b20e49`](https://github.com/AmpersandHQ/normalize-scss/commit/0b20e4923f52ff1c1cf9e2cbdbb506f68d270c01)
- Language [`ee50234`](https://github.com/AmpersandHQ/normalize-scss/commit/ee50234bcc0a5ab2c1cfb1ad174cac8720c9c93c)
- Update [`4dc9bb4`](https://github.com/AmpersandHQ/normalize-scss/commit/4dc9bb470a59302abb65b3829d4f18bc2008e07d)
- Update [`fa92fc7`](https://github.com/AmpersandHQ/normalize-scss/commit/fa92fc78e43e1a17bcd5811cb828481000d192c1)
- Rename demo.html to test.html [`4ed3786`](https://github.com/AmpersandHQ/normalize-scss/commit/4ed3786354f4a15884a3a391ab9a9cd681529ed0)
- Update [`7942a21`](https://github.com/AmpersandHQ/normalize-scss/commit/7942a2198deb44c944a1058025517e6d9001db0b)
- Convert deprecated /*! */ comment style into /* */ comment. [`64e2214`](https://github.com/AmpersandHQ/normalize-scss/commit/64e22143d1f28c40f43e6d00352a066318f8a97c)
- Language [`60cc15c`](https://github.com/AmpersandHQ/normalize-scss/commit/60cc15c3868e54309e2c5516a918d0b1c750e014)
- Add a test for the [hidden] attribute [`45a7355`](https://github.com/AmpersandHQ/normalize-scss/commit/45a73553465767a7d11dd90f397a3434effe1c27)
- Update component.json for 'component' support [`f29e03a`](https://github.com/AmpersandHQ/normalize-scss/commit/f29e03ae8f4485dbf959c9db09e88fa5bdbeaf86)
- Add .gitignore file [`7751935`](https://github.com/AmpersandHQ/normalize-scss/commit/77519357af5681a069af4469d08ffa1e4bb26e9d)
- Updated README.md [`86bae9a`](https://github.com/AmpersandHQ/normalize-scss/commit/86bae9a4f81645d36fe83494725fa130b11a5ce5)
- Renamed normalize.css to normalize.scss. [`0eb4bfa`](https://github.com/AmpersandHQ/normalize-scss/commit/0eb4bfa928c0c448b559b9decbe1863302b6a46c)
- Renamed normalize.css to normalize.scss. [`6e32fe9`](https://github.com/AmpersandHQ/normalize-scss/commit/6e32fe9d7ba477378acdfd62e0954591b423a5a0)
- Renamed normalize.css to normalize.scss. [`cd1a49e`](https://github.com/AmpersandHQ/normalize-scss/commit/cd1a49ecc3a2340bfe9ec71bd0d78c371d33f8a1)
- Rename LICENSE to LICENSE.md [`ddf9243`](https://github.com/AmpersandHQ/normalize-scss/commit/ddf924369df366802ceef1ef750a721618a8cf82)
- Renamed normalize.css to normalize.scss. [`cba3ff7`](https://github.com/AmpersandHQ/normalize-scss/commit/cba3ff785f6e41d068d327d7f28645d67f8f3b76)
- Renamed normalize.css to normalize.scss. [`79b54b4`](https://github.com/AmpersandHQ/normalize-scss/commit/79b54b4a1fb5e7545804e9b1fa1847a3d97e5dd3)
- It has begun. [`0434c40`](https://github.com/AmpersandHQ/normalize-scss/commit/0434c40f4dd704cf4c5df1825905e2276495db72)
